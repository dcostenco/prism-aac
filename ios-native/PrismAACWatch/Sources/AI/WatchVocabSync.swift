...
extension WatchCategory {
    ...
    /// iOS-parity default set — mirrors `constants/categories.ts`
    /// DEFAULT_CATEGORIES top-level entries (22 categories). Used when the
    /// companion iPhone hasn't synced yet OR no auth token is in keychain.
    /// Each category carries a curated minimum so taps don't open empty
    /// detail sheets. Sync rule: when constants/categories.ts changes,
    ...
    static let iOSDefaultSet: [WatchCategory] = [
        ...
        WatchCategory(id: "core-verbs", icon: "bolt.fill", name: "Core Verbs", phrases: [
            ...
            WatchPhrase(id: "stop", label: "Stop", arasaacId: 5581, sfSymbol: "hand.raised.fill"),
            WatchPhrase(id: "have", label: "Have", arasaacId: nil,  sfSymbol: "hand.thumbsup"),
            WatchPhrase(id: "like", label: "Like", arasaacId: nil,  sfSymbol: "heart"),
            WatchPhrase(id: "see",  label: "See",  arasaacId: nil,  sfSymbol: "eye"),
            WatchPhrase(id: "help", label: "Help", arasaacId: 5557, sfSymbol: "sos"),
        ...
        WatchCategory(id: "core-descriptors", icon: "ruler.fill", name: "More / Not / All", phrases: [
            ...
            WatchPhrase(id: "some", label: "Some",     arasaacId: nil,  sfSymbol: "circle.dotted"),
        ...
        WatchCategory(id: "core-little-words", icon: "link", name: "Little Words", phrases: [
            ...
            WatchPhrase(id: "my",   label: "my",   arasaacId: nil, sfSymbol: "person.crop.circle"),
            WatchPhrase(id: "your", label: "your", arasaacId: nil, sfSymbol: "person.crop.circle.badge.checkmark"),
        ]),
        ...
        WatchCategory(id: "help-needs", icon: "sos", name: "Help / Needs", phrases: [
            ...
            WatchPhrase(id: "food-n",   label: "Food",     arasaacId: nil,  sfSymbol: "fork.knife"),
            WatchPhrase(id: "hurt-n",   label: "Hurt",     arasaacId: nil,  sfSymbol: "cross.fill",          isEmergency: true),
            WatchPhrase(id: "tired-n",  label: "Tired",    arasaacId: nil,  sfSymbol: "moon.zzz.fill"),
        ...
        WatchCategory(id: "feelings", icon: "face.smiling", name: "Feelings", phrases: [
            ...
            WatchPhrase(id: "angry",   label: "Angry",   arasaacId: nil, sfSymbol: "flame.fill"),
        ...
        WatchCategory(id: "questions", icon: "questionmark.circle.fill", name: "Questions", phrases: [
            ...
            WatchPhrase(id: "why",   label: "Why?",   arasaacId: nil, sfSymbol: "exclamationmark.bubble"),
            WatchPhrase(id: "when",  label: "When?",  arasaacId: nil, sfSymbol: "clock"),
            WatchPhrase(id: "how",   label: "How?",   arasaacId: nil, sfSymbol: "questionmark.diamond"),
        ]),
        ...
        WatchCategory(id: "actions", icon: "figure.run", name: "Actions", phrases: [
            ...
            WatchPhrase(id: "stand", label: "Stand", arasaacId: nil, sfSymbol: "figure.stand"),
            WatchPhrase(id: "sleep", label: "Sleep", arasaacId: nil, sfSymbol: "bed.double.fill"),
            WatchPhrase(id: "eat",   label: "Eat",   arasaacId: nil, sfSymbol: "fork.knife"),
        ...
        WatchCategory(id: "describing", icon: "paintpalette.fill", name: "Describing Words", phrases: [
            ...
            WatchPhrase(id: "cold-d",  label: "Cold",  arasaacId: nil, sfSymbol: "thermometer.snowflake"),
            WatchPhrase(id: "fast-d",  label: "Fast",  arasaacId: nil, sfSymbol: "hare"),
            WatchPhrase(id: "slow-d",  label: "Slow",  arasaacId: nil, sfSymbol: "tortoise"),
        ...
        WatchCategory(id: "people-social", icon: "person.3.fill", name: "People", phrases: [
            ...
            WatchPhrase(id: "teacher", label: "Teacher", arasaacId: nil, sfSymbol: "graduationcap.fill"),
        ...
        WatchCategory(id: "food-ordering", icon: "fork.knife", name: "Food & Drink", phrases: [
            ...
            WatchPhrase(id: "milk",    label: "Milk",    arasaacId: nil,  sfSymbol: "cup.and.saucer"),
        ...
        WatchCategory(id: "places-plans", icon: "mappin.and.ellipse", name: "Places", phrases: [
            ...
            WatchPhrase(id: "store",   label: "Store",   arasaacId: nil,  sfSymbol: "cart.fill"),
        ...
        WatchCategory(id: "time", icon: "clock.fill", name: "Time", phrases: [
            ...
            WatchPhrase(id: "yesterday", label: "Yesterday", arasaacId: nil, sfSymbol: "calendar.badge.minus"),
            WatchPhrase(id: "tomorrow",  label: "Tomorrow",  arasaacId: nil, sfSymbol: "calendar.badge.plus"),
        ...
        WatchCategory(id: "colors", icon: "paintpalette", name: "Colors", phrases: [
            ...
            WatchPhrase(id: "yellow", label: "Yellow", arasaacId: nil, sfSymbol: "circle.fill"),
            WatchPhrase(id: "pink",   label: "Pink",   arasaacId: nil, sfSymbol: "circle.fill"),
        ...
        WatchCategory(id: "weather", icon: "cloud.sun.fill", name: "Weather", phrases: [
            ...
            WatchPhrase(id: "hot-w",   label: "Hot",    arasaacId: nil, sfSymbol: "thermometer.sun"),
        ...
        WatchCategory(id: "toys-fun", icon: "gamecontroller.fill", name: "Toys & Fun", phrases: [
            ...
            WatchPhrase(id: "game",   label: "Game",  arasaacId: nil, sfSymbol: "gamecontroller.fill"),
            WatchPhrase(id: "music",  label: "Music", arasaacId: nil, sfSymbol: "music.note"),
        ]),
    ]
}
