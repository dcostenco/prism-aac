  ...
  return (
    <div className="flex-[2] min-h-0 overflow-auto surface-app" data-testid="browser-content">
      <div className="flex flex-col items-center justify-center min-h-full gap-3 p-3 sm:p-4">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-6 gap-2.5 sm:gap-3 w-full max-w-lg">
          {BOOKMARKS.map(b => (
            <button
              ...
              aria-label={b.label}
              className="aac-btn flex flex-col items-center justify-center gap-1.5 p-3 sm:p-4 rounded-xl surface-key border border-theme text-xs sm:text-sm font-semibold select-none min-h-[80px] sm:min-h-[88px] focus-visible:ring-2 focus-visible:ring-blue-400"
            >
        ...
        <p className="text-xs text-muted text-center max-w-xs hidden portrait:block">
