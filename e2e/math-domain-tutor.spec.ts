...
test.describe("Phase 6 — Chemistry tab", () => {
  test("chemistry chip swaps the keyboard panel and exposes element keys", async ({
    page,
    baseURL,
  }) => {
    ...
    await expect(
      page.locator('[data-testid="math-chemistry-keyboard"]'),
    ).toBeVisible();
    // Element row has H / O / Cl / Na buttons.
    await expect(
      page.locator('[data-testid="math-chemistry-elements-hydrogen"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="math-chemistry-elements-oxygen"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="math-chemistry-elements-chlorine"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="math-chemistry-elements-sodium"]'),
    ).toBeVisible();
    // Reaction arrow + subscript exist on the ops row.
    await expect(
      page.locator('[data-testid="math-chemistry-ops-yields"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="math-chemistry-ops-subscript-2"]'),
    ).toBeVisible();
  });
  ...
  test("typing H + ₂ + O commits 3 cells", async ({ page, baseURL }) => {
    ...
    await page
      ...
      .click();
    await page
      .locator('[data-testid="math-chemistry-ops-subscript-2"]')
      .click();
    await page
      .locator('[data-testid="math-chemistry-elements-oxygen"]')
      .click();
...
test.describe("Phase 6 — Physics tab", () => {
  test("physics chip swaps the keyboard panel and exposes greek + units", async ({
    page,
    baseURL,
  }) => {
    await gotoDev(page, baseURL);
    ...
    await expect(
      page.locator('[data-testid="math-physics-keyboard"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="math-physics-greek-alpha"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="math-physics-greek-omega"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="math-physics-units-newton"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="math-physics-units-joule"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="math-physics-ops-integral"]'),
    ).toBeVisible();
  });

  test("typing α commits one cell containing the alpha glyph", async ({
    page,
    baseURL,
  }) => {
    await gotoDev(page, baseURL);
...
test.describe("Phase 6 — Programming tabs (Python + Java)", () => {
  test("python chip renders ops + python keywords", async ({
    page,
    baseURL,
  }) => {
    await gotoDev(page, baseURL);
    ...
    await expect(
      page.locator('[data-testid="math-programming-python-keyboard"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="math-python-kw-def"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="math-python-kw-print"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="math-python-ops-colon"]'),
    ).toBeVisible();
    // Java keywords MUST NOT be on the python tab.
    await expect(
      page.locator('[data-testid="math-java-kw-public"]'),
    ).toHaveCount(0);
  });
  ...
  test("java chip renders ops + java keywords", async ({ page, baseURL }) => {
    ...
    await expect(
      page.locator('[data-testid="math-programming-java-keyboard"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="math-java-kw-public"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="math-java-kw-class"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="math-java-ops-semicolon"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="math-python-kw-def"]'),
    ).toHaveCount(0);
  ...
  test("python keywords commit char-by-char with a trailing space", async ({
    page,
    baseURL,
  }) => {
    await gotoDev(page, baseURL);
