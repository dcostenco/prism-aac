...
# Prism AAC — 拡大代替コミュニケーション



**実生活のために作られたコミュニケーション。**
...
ほとんどのAACアプリは選択を強います：絵カードかキーボードか。Prism AACは画面を切り替えることなく両方を利用可能にします。キーボードは常にワンタップで、予測はあなたが実際に言うことを学習し、カテゴリは実際の状況に基づいて構築されています。
