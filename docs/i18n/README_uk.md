...
# Prism AAC — Аугментативна та альтернативна комунікація



**Комунікація, створена для реального життя.**
...
Більшість AAC-додатків змушують обирати: дошки з картинками або клавіатура. Prism AAC зберігає обидва варіанти без зміни екрану. Клавіатура завжди на відстані одного дотику, передбачення вчаться тому, що ви насправді говорите, а категорії побудовані навколо реальних ситуацій.
...
[← Назад до README англійською](../../README.md)
